...
grades.getById = (id, query = '') => api.get(`/grades/${id}?${query}`).then(res => res.data);
...
grades.lessons = (id) => api.get(`/grades/${id}/lessons`).then(res => res.data);
...
grades.studentsWithAttendances = (id) => api.get(`/grades/${id}/students/attendances`).then(res => res.data);
